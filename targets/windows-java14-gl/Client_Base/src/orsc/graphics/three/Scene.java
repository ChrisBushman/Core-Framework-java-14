...
public final class Scene implements SceneRenderer {
	...
	public final int resourceToColor(int resource, boolean var2) {
		try {
	...
	public final void setFogLandscapeDistance(int distance) {
		this.fogLandscapeDistance = distance;
	}

	public final void setFogEntityDistance(int distance) {
		this.fogEntityDistance = distance;
	}

	public final void setFogZFalloff(int falloff) {
		this.fogZFalloff = falloff;
	}

	public final void setFogSmoothingStartDistance(int distance) {
		this.fogSmoothingStartDistance = distance;
	}

	public final RSModel getSpriteBillboardModel() {
		return this.m_T;
	}

	/** No-op here - endScene() already draws directly into pixelData; see the interface doc comment. */
	public final void captureFrameToPixelData() {
	}

	public final void removeAllGameObjects(boolean var1) {
		try {
